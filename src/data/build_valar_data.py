...
tf.app.flags.DEFINE_string('output_directory', '../../data/records_valar/',
...
def _process_image_files_batch(coder, thread_index, ranges, name, filenames,
  ...
  for s in range(num_shards_per_batch):
    ...
    output_filename = '%s-%.5d-of-%.5d-valar.record' % (name, shard, num_shards)
...
def _find_image_files(data_dir, labels_file):
  ...
  for fn in fnames:
    f = u.del_file_ext(fn)
    label_arr = [dl_dict['valence'][f], dl_dict['arousal'][f]]
...
def build_text(label_arr):
  return "Valence: {}, Arousal: {}".format(label_arr[0], label_arr[1])
